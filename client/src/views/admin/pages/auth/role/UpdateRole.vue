...
import {ref} from "vue";
import {MenuEntity, PermissionEntity, Service, UpdateRoleDto, VerificationResult} from "~/generated";
...
const data = ref<UpdateRoleDto>(defaultData());
